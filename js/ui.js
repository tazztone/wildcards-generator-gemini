        ...
        return `
            ...
            <div class="flex justify-between items-center mt-3 flex-wrap gap-2">
                ...
                <div class="flex gap-1 ml-auto">
                    <button class="copy-btn btn-secondary text-gray-400 hover:text-white p-2 rounded-md transition-colors" title="Copy all ${count} wildcards" aria-label="Copy all ${count} wildcards" data-original-title="Copy all ${count} wildcards"><span class="btn-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg></span></button>
